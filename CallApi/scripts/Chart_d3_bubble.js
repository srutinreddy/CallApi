...
app.controller('controller1', function ($scope, $http) {
    $http.get("http://wipro.azurewebsites.net/api/integratedpulse/all").then(function (response) {
        ...
        console.log(total);
        graph(total, open, identified, hold, needclarity);
    })
});
...
function graph(total, open, identified, hold, needclarity) {

    var gauge1 = loadLiquidFillGauge("fillgauge1", total);
    var config1 = liquidFillGaugeDefaultSettings();
    config1.circleColor = "green";
    config1.textColor = "black";
    config1.waveTextColor = "white";
    config1.waveColor = "green";
    config1.textSize = 0.8;
    config1.circleThickness = 0.2;
    config1.textVertPosition = 0.5;
    config1.waveAnimateTime = 1000;
    config1.displayPercent = true;
    var gauge2 = loadLiquidFillGauge("fillgauge2", open * 100 / total, config1);
    var config2 = liquidFillGaugeDefaultSettings();
    config2.circleColor = "red";
    config2.textColor = "black";
    config2.waveTextColor = "red";
    config2.waveColor = "red";
    ...
    config4.textSize = 0.8;
    config4.waveCount = 3;
    config4.displayPercent = true;
    var gauge5 = loadLiquidFillGauge("fillgauge5", needclarity * 100 / total, config4);
